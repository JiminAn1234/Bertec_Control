...
def main():  
    ...
    #trial_name = "PT01_Changseob_R0p8_L1p2"
    ...
    # trial_name = "AB01_Jimin_1p2ms_10p140ms"
    # trial_name = "AB01_Jimin_1p2ms_10p120ms"
    # trial_name = "AB01_Jimin_1p2ms_10p80ms"
    # trial_name = "AB01_Jimin_1p2ms_25p100ms"
    
    trial_name = "AB01_Jimin_1p2ms_NoExo"
    
    
    trial_notes = "250409 Run by master python script."
    trial_description = (" ")
