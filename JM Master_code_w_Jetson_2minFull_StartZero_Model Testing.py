...
def main():  
    # subject_name = "AB05" # Changseob
    # subject_name = "AB11"
    # subject_name = "AB17" # Itak
    subject_name = "AB18" # Arnav
    ...
    # magnitude = "10p" # magnitude = "15p"
    magnitude = "20p"
    # magnitude = "25p" # magnitude = "30p"

    delay = "30ms"
    # delay = "100ms"
    # delay = "170ms" # delay = "200ms"
    # delay = "240ms" # delay = "250ms"
    # delay = "310ms" # delay = "300ms"
    ...
    while(command):
        ...
        trial_number += 1
        trial_name = f"{subject_name}_{Model_Name}_{task}_{magnitude}{delay}_{trial_number}"
